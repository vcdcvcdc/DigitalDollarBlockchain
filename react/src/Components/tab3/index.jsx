      ...
      <div className="text-box" id="features">
        <div className="scroll-content">
          ...
          <p>
            ...
            decisions and activities of users within the marketplace, devoid of
            influence from a concentrated ownership group. Each DD reflects the
            economic activities of its users, safeguarded against manipulation.
          </p>
          <p>
            ...
            chasing profits. This democratization of financial services promotes
            wider user participation, enhancing the strength and flexibility of
            our platform.
          </p>
          <p>
            Our native token, Karma, introduces a groundbreaking method of
            managing transaction fees, popularly known as 'gas fees'. Rather
            than accruing costs with each transaction, users earn Karma points,
            which are used to cover transaction fees. This innovative model
            removes the deterrent of transaction costs, enabling free
          ...
          <p>
            ...
            offers users the flexibility to transact across different ecosystems
            with ease.
          </p>
          <p>
          ...
          <p>
            ...
            about volatile values, high transaction costs, or complex processes.
          </p>
        </div>
      </div>
    </Animator>
